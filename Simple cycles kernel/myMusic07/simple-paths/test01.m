...
%res = load('../../../Documents/workspace/MyMusic/Adjacency/ea43fad7-4770-482d-8ebc-e53cfd53b7f8');
res = load('../../../Documents/workspace/MyMusic/Adjacency/fb57a896-890e-4f75-855c-781686f007f7');
p = 4;

[A,ht] = convertAdjacency(res);
[C,D,cycles,paths] = simplePaths02(sparse(A),p);
...
%=== We print the result (translated) ===
'These are all self-avoiding cycles'
e = cycles.keys();
