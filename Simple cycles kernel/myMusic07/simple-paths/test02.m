...
[C,D,cycles,paths] = simplePaths05(A,p);
...
save([dirout,'/Cycles/',res,'.mat'],'saveCycles');
    ...
    for i=1:row
        ...
        for j=1:col
            ...
            if (j ~= col)
                  ...
                  newpath = [newpath,' ',chordlist{aux(1)},' ',chordlist{aux(2)}];
            end
        end
        newpath
...
save([dirout,'/Paths/',res,'.mat'],'savePaths');
