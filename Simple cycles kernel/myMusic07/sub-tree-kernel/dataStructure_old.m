function Graphs = dataStructure_old()
%=======================================================================
...
%dirs = {'../AdjacencyIntervalsSelected'};
%dirs = {'../AdjacencyIntervalsTest'};
...
for i=1:numItems %%%%% CORREGIR ESTO!!!
	'%%%%%%%%%%%%%% NEW ITEM %%%%%%%%%%%%%%'
	cend = cbegin + 35;
	...
	%labels = 1:size(adj,2); %%% CAREFUL!! This may not be the whole graph
    labels = 1:9100;
	labels = labels';
